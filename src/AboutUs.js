    ...
    return (
        <div className="aboutUsPage">
            <div className="aboutUsPgTop">
                ...
                <p className="aboutUsSubText">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus optio, quisquam dolore cumque et quidem asperiores obcaecati earum, quis ad voluptatum dolores, atque vel eaque odit sed? Debitis, eius repellendus.</p>
            </div>
            <div className="aboutUsPgMid">
                <div>
                    ...
                    <p className='aboutMidSubText'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus et minima provident aperiam reiciendis pisci accusamus facilis jert. Praesentium dolorem suntac cusantium, sed reprehenderit quod distinctio non, maxime eum provident quaerat. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat a neque hic sed.</p>
                    <p className='aboutMidSubText'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum adipisci neque assumenda poribus est omnis illo laudantium fugit vero maxime architecto corrupti quia, provident otio impedit voluptatem officiis maiores harum labore numquam nam totam unde! Votates iste sed harum sit laboriosam quasi consectetur. Facilis, itaque.</p>
                </div>
                <div>
            ...
            <div className='teamDiv'>
                ...
                <p className='teamDivSubText'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, commodi repellendus voluptas atque dicta, cupiditate vel sit nemo labore iusto ut dolorum quibusdam pariatur voluptates sed delectus itaque architecto? Quia cupiditate, fugit labore delectus architecto reiciendis vero saepe minima nihil voluptatibus ratione nesciunt debitis? Iste!</p>
