            ...
            <div className="futa">
                <footer>
                    <div>
                        ...
                        <p className="footerText">Skill nest is the top-leading platform for learning digital skills, with great <br /> instructors and a robust curriculum, we got you covered 😉!</p>
                    </div>
                ...
                <div className="bottomText">
                    ...
                    <div>
                        <p>
                            Made by <a href="https://x.com/AdeleyeOlu89360?s=08" className="bottom-link">Olùwámâyõwá</a>
                        </p>
                    </div>
                </div>
            </div>
